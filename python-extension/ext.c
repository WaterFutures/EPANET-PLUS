...
PyMethodDef EpanetMethods[] = {
    ...
    {"EN_setlinkvalues", method_EN_setlinkvalues, METH_VARARGS, "Python interface for EN_setlinkvalues C function from EPANET"},
    ...
    {"EN_setnodevalues", method_EN_setnodevalues, METH_VARARGS, "Python interface for EN_setnodevalues C function from EPANET"},
    {"EN_getnodevalues_NPY", method_EN_getnodevalues_NPY, METH_VARARGS, "NumPy compatible Python interface for EN_getnodevalues C function from EPANET"},
    {"EN_getlinkvalues", method_EN_getlinkvalues, METH_VARARGS, "Python interface for EN_getlinkvalues C function from EPANET"},
    {"EN_getlinkvalues_NPY", method_EN_getlinkvalues_NPY, METH_VARARGS, "Numpy compatible Python interface for EN_getlinkvalues C function from EPANET"},
    ...
    {"ENsetlinkvalues", method_ENsetlinkvalues, METH_VARARGS, "Python interface for ENsetlinkvalues C function from EPANET"},
    ...
    {"ENsetnodevalues", method_ENsetnodevalues, METH_VARARGS, "Python interface for ENsetnodevalues C function from EPANET"},
    ...
    {"ENgetnodevalues_NPY", method_ENgetnodevalues_NPY, METH_VARARGS, "NumPy compatible Python interface for ENgetnodevalues C function from EPANET"},
    {"ENgetlinkvalues", method_ENgetlinkvalues, METH_VARARGS, "Python interface for ENgetlinkvalues C function from EPANET"},
    {"ENgetlinkvalues_NPY", method_ENgetlinkvalues_NPY, METH_VARARGS, "NumPy compatible Python interface for ENgetlinkvalues C function from EPANET"},
